...
10.times do
  User.create(
    ...
    password: 'fatiguee',
    password_confirmation: 'fatiguee'
    )
end
...
#Création de 30 commentaires répartis aléatoirement
30.times do
  c = Comment.create(content: Faker::TvShows::DrWho.quote, gossip: Gossip.all[rand(0..19)], user: User.all[rand(0..9)])
end
